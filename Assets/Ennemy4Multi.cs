...
public class Ennemy4Multi : Enemy
{
    ...
    void Update()
    {
        ...
        if ((_player2.transform.position.x >= _waypoints[0].transform.position.x && _player2.transform.position.x <= _waypoints[1].transform.position.x))
        {
            LookAtSomething(_player2.GetComponent<Transform>());
            ...
            else
            {
                ...
                direction = (_player2.transform.position - transform.position).normalized;
            }
        }
        else if ((_player2Join.transform.position.x >= _waypoints[0].transform.position.x && _player2Join.transform.position.x <= _waypoints[1].transform.position.x))
        {
            LookAtSomething(_player2Join.GetComponent<Transform>());
            //Vector2.Distance(_player.transform.position,transform.position)<2.1f
            if (CanAttack(attackCollider.GetComponent<Collider2D>()))
            {
                animator.SetBool("attack",true);
            ...
            {
                animator.SetBool("attack",false);
                direction = (_player2Join.transform.position - transform.position).normalized;
            }
        }
